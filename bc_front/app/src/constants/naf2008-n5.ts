/**
 * NAF rev. 2 (2008) — niveau 5 (sous-classes).
 * Source : fichier officiel liste N5.
 *
 * Les codes sont des chaînes du type « 62.01Z » : un `enum` TypeScript ne peut pas
 * les utiliser comme identifiants de membres. Ce `const` typé joue le rôle de table
 * de correspondance code → libellé.
 */

export const NAF2008_N5 = {
...
export type Naf2008N5Code = keyof typeof NAF2008_N5

export function getNaf2008N5Label(code: string): string | undefined {
  return Object.prototype.hasOwnProperty.call(NAF2008_N5, code)
    ? NAF2008_N5[code as Naf2008N5Code]
    : undefined
}